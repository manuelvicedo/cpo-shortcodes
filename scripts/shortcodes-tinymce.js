					...
					menu: [
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									onsubmit: function(e){
										...
										editor.selection.setContent('[' + ctsc_vars.prefix + 'button url="' + e.data.url + '" color="' + e.data.color + '" background="' + e.data.background + '" gradient="' + e.data.gradient + '" description="' + e.data.description + '" size="' + e.data.size + '" position="' + e.data.position + '" icon="' + e.data.icon + '" target="' + e.data.target + '" rel="' + e.data.rel + '"' + element_id + element_class + element_animation + ']' + e.data.text + '[/' + ctsc_vars.prefix + 'button]');
									}
								});
							}
						},
						{
							...
							onclick: function(){ 
								editor.windowManager.open({
									title: 'Add Focus Box',
									body: ctsc_generator_focus,
									onsubmit: function(e){
										var element_id = e.data.id !== '' ? ' id="' + e.data.id + '"' : '';
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'focus background="' + e.data.background + '" gradient="' + e.data.gradient + '" color="' + e.data.color + '" style="' + e.data.style + '" ' + element_id + element_class + element_animation + ']' + editor.selection.getContent() + '[/' + ctsc_vars.prefix + 'focus]');
									}
								});
							}
						},
						{
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									body: ctsc_generator_message,
									onsubmit: function(e){
										var element_id = e.data.id !== '' ? ' id="' + e.data.id + '"' : '';
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'message type="' + e.data.type + '" ' + element_id + element_class + element_animation + ']' + editor.selection.getContent() + '[/' + ctsc_vars.prefix + 'message]');								
									}
								});
							}
						},
						{
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									body: ctsc_generator_progress,
									onsubmit: function(e){
										var element_id = e.data.id !== '' ? ' id="' + e.data.id + '"' : '';
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'progress value="' + e.data.value + '" title="' + e.data.title + '" icon="' + e.data.icon + '" background="' + e.data.background + '" gradient="' + e.data.gradient + '" size="' + e.data.size+'"  id="' + e.data.id +  '" class="' + e.data.class + '" animation="' + e.data.animation + '"]' + editor.selection.getContent() + '[/' + ctsc_vars.prefix + 'progress]');
									}
								});
							}
						},
						{
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									body: ctsc_generator_feature,
									onsubmit: function(e){
										var element_id = e.data.id !== '' ? ' id="' + e.data.id + '"' : '';
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'feature title="' + e.data.title + '" icon="' + e.data.icon + '" color="' + e.data.color + '" background="' + e.data.background + '" gradient="' + e.data.gradient + '" image="' + e.data.image + '" style="' + e.data.style + '" ' + element_id + element_class + element_animation + ']' + editor.selection.getContent() + '[/' + ctsc_vars.prefix + 'feature]');
									}
								});
							}
						},
						{
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									body: ctsc_generator_team,
									onsubmit: function(e){
										var element_id = e.data.id !== '' ? ' id="' + e.data.id + '"' : '';
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'team name="' + e.data.name + '" title="' + e.data.title + '" image="' + e.data.image + '" web="' + e.data.web + '" facebook="' + e.data.facebook + '" twitter="' + e.data.twitter +'" gplus="' + e.data.gplus + '" linkedin="' + e.data.linkedin + '" pinterest="' + e.data.pinterest + '" Tumblr="' + e.data.Tumblr + '" ' + element_id + element_class + element_animation + ']' + editor.selection.getContent() + '[/' + ctsc_vars.prefix + 'team]');
									}
								});
							}
						},
						{
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									body: ctsc_generator_testimonial,
									onsubmit: function(e){
										var element_id = e.data.id !== '' ? ' id="' + e.data.id + '"' : '';
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'testimonial name="' + e.data.name + '" title="' + e.data.title + '" image="' + e.data.image + '" style="' + e.data.style + '" ' + element_id + element_class + element_animation + ']' + editor.selection.getContent() + '[/' + ctsc_vars.prefix + 'testimonial]');
									}
								});
							}
						},
						{
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									body: ctsc_generator_counter,
									onsubmit: function(e){
										var element_id = e.data.id !== '' ? ' id="' + e.data.id + '"' : '';
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'counter number="' + e.data.number + '" title="' + e.data.title + '" icon="' + e.data.icon + '" color="' + e.data.color + '" size="' + e.data.size + '" ' + element_id + element_class + element_animation + ']' + editor.selection.getContent() + '[/' + ctsc_vars.prefix + 'counter]');
									}
								});
							}
						},
					...
					menu: [		
						{
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									body: ctsc_generator_accordion,
									onsubmit: function(e){
										var element_id = e.data.id !== '' ? ' id="' + e.data.id + '"' : '';
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'accordion text="' + e.data.text + '" icon="' + e.data.icon + '" state="' + e.data.state + '" style="' + e.data.style + '" group="' + e.data.group + '" ' + element_id + element_class + element_animation + ']' + editor.selection.getContent() + '[/' + ctsc_vars.prefix + 'accordion]');
									}
								});
							}
						},
							...
							menu: [
								{
									...
									onclick: function(){ 
										editor.windowManager.open({
											title: 'Add Tab Group',
											body: ctsc_generator_tab_group,
											onsubmit: function(e){
												var element_id = e.data.id !== '' ? ' id="' + e.data.id + '"' : '';
												var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
												var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
												editor.selection.setContent('[' + ctsc_vars.prefix + 'tabs style="' + e.data.style + '" ' + element_id + element_class + element_animation + '][/' + ctsc_vars.prefix + 'tabs]');
											}
										});
									}
								},
								{
									...
									onclick: function(){ 
										editor.windowManager.open({
											...
											body: ctsc_generator_tab,
											onsubmit: function(e){
												editor.selection.setContent('[' + ctsc_vars.prefix + 'tab title="' + e.data.title +  '"]' + editor.selection.getContent() + '[/' + ctsc_vars.prefix + 'tab]');
											}
										});
									}
								}
							...
							menu: [
								{
									...
									onclick: function(){ 
										editor.windowManager.open({
											...
											body: ctsc_generator_slideshow,
											onsubmit: function(e){
												var element_id = e.data.id !== '' ? ' id="' + e.data.id + '"' : '';
												var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
												var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
												editor.selection.setContent('[' + ctsc_vars.prefix + 'slideshow images="' + e.data.timages +  '" effect="' + e.data.effect +  '" speed="' + e.data.speed +  '" timeout="' + e.data.timeout +  '" pager="' + e.data.pager +  '" navigation="' + e.data.navigation +  '" ' + element_id + element_class + element_animation + '][/' + ctsc_vars.prefix + 'slideshow]');
											}
										});
									}
								},
								{
									text:'Single Slide',
									onclick: function(){ 									
										editor.selection.setContent('[' + ctsc_vars.prefix + 'slide]' + editor.selection.getContent() + '[/' + ctsc_vars.prefix + 'tab]');
									}
								}
							]
						},
						{
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									body: ctsc_generator_map,
									onsubmit: function(e){
										var element_id = e.data.id !== '' ? ' id="' + e.data.id + '"' : '';
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'map color="' + e.data.color +  '" height="' + e.data.height +  '" latitude="' + e.data.latitude +  '" longitude="' + e.data.longitude + '" ' + element_id + element_class + element_animation + '][/' + ctsc_vars.prefix + 'map]');
									}
								});
							}
						},
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									onsubmit: function(e){
										...
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'pricing title="' + e.data.title +  '" subtitle="' + e.data.subtitle +  '" price="' + e.data.price +  '" before="' + e.data.before + '" after="' + e.data.after + '"  description="' + e.data.description + '" color="' + e.data.color + '" type="' + e.data.type + '" ' + element_id + element_class + element_animation + '][/' + ctsc_vars.prefix + 'pricing]');
									}
								});
							}
						},
						{
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									body: ctsc_generator_optin,
									onsubmit: function(e){
										var element_id = e.data.id !== '' ? ' id="' + e.data.id + '"' : '';
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'optin url="' + e.data.url +  '" captcha="' + e.data.captcha +  '" email="' + e.data.email +  '" firstname="' + e.data.firstname + '" lastname="' + e.data.lastname + '" submit="' + e.data.submit + '"  style="' + e.data.style + '" ' + element_id + element_class + element_animation + '][/' + ctsc_vars.prefix + 'optin]');
									}
								});
							}
						},
					...
					menu: [			
						{
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									body: ctsc_generator_dropcap,
									onsubmit: function(e){
										var element_id = e.data.id !== '' ? ' id="' + e.data.id + '"' : '';
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'dropcap color="' + e.data.color +  '" style="' + e.data.style + '" ' + element_id + element_class + element_animation + ']' + e.data.text +  '[/' + ctsc_vars.prefix + 'optin]');
									}
								});
							}
						},
						{
							text:'Leading', 
							onclick: function(){ 
								editor.selection.setContent('[' + ctsc_vars.prefix + 'leading]' + editor.selection.getContent() + '[/' + ctsc_vars.prefix + 'leading]'); 
							} 
						},
						{
							text:'List Item',
							onclick: function(){ 
								editor.windowManager.open({
									title: 'Add New List',
									body: ctsc_generator_list,
									onsubmit: function(e){
										var element_id = e.data.id !== '' ? ' id="' + e.data.id + '"' : '';
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'list icon="' + e.data.icon +  '" content="' + e.data.content +  '" color="' + e.data.color +  '" background="' + e.data.background + '" gradient="' + e.data.gradient +  '" style="' + e.data.style +  '" ' + element_id + element_class + element_animation + ']' + e.data.content +  '[/' + ctsc_vars.prefix + 'list]');
									}
								});
							}
						},
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									onsubmit: function(e){
										...
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'posts type="' + e.data.type +  '" number="' + e.data.number +  '" columns="' + e.data.columns + '" style="' + e.data.style +  '" date="' + e.data.date +  '" author="' + e.data.author +  '" comments="' + e.data.comments +  '" excerpt="' + e.data.excerpt +  '" after="' + e.data.after +  '" description="' + e.data.description +  '" color="' + e.data.color +  '" ' + element_id + element_class + element_animation + ']');
									}
								});
							}
						},
					...
					menu: [			
						...
						},
						{
							...
							onclick: function(){ 
								editor.windowManager.open({
									title: 'Add Columns',
									body: ctsc_generator_columns,
									onsubmit: function(e){
										var element_columns = e.data.columns;
										var element_style = e.data.style !== 'normal' ? ' style="' + e.data.style + '"' : '';
										switch(element_columns){
											case '2': editor.selection.setContent('[' + ctsc_vars.prefix + 'column_half' + element_style + ']<br><br>' + editor.selection.getContent() + '<br><br>[/' + ctsc_vars.prefix + 'column_half][' + ctsc_vars.prefix + 'column_half_last' + element_style + ']<br><br>' + editor.selection.getContent() + '<br><br>[/' + ctsc_vars.prefix + 'column_half_last]'); break;
											case '3': editor.selection.setContent('[' + ctsc_vars.prefix + 'column_third' + element_style + ']<br><br>' + editor.selection.getContent() + '<br><br>[/' + ctsc_vars.prefix + 'column_third][' + ctsc_vars.prefix + 'column_third' + element_style + ']<br><br>' + editor.selection.getContent() + '<br><br>[/' + ctsc_vars.prefix + 'column_third][' + ctsc_vars.prefix + 'column_third_last' + element_style + ']<br><br>' + editor.selection.getContent() + '<br><br>[/' + ctsc_vars.prefix + 'column_third_last]'); break;
											case '4': editor.selection.setContent('[' + ctsc_vars.prefix + 'column_fourth' + element_style + ']<br><br>' + editor.selection.getContent() + '<br><br>[/' + ctsc_vars.prefix + 'column_fourth][' + ctsc_vars.prefix + 'column_fourth' + element_style + ']<br><br>' + editor.selection.getContent() + '<br><br>[/' + ctsc_vars.prefix + 'column_fourth][' + ctsc_vars.prefix + 'column_fourth' + element_style + ']<br><br>' + editor.selection.getContent() + '<br><br>[/' + ctsc_vars.prefix + 'column_fourth][' + ctsc_vars.prefix + 'column_fourth_last' + element_style + ']<br><br>' + editor.selection.getContent() + '<br><br>[/' + ctsc_vars.prefix + 'column_fourth_last]'); break;
											case '5': editor.selection.setContent('[' + ctsc_vars.prefix + 'column_fifth' + element_style + ']<br><br>' + editor.selection.getContent() + '<br><br>[/' + ctsc_vars.prefix + 'column_fifth][' + ctsc_vars.prefix + 'column_fifth' + element_style + ']<br><br>' + editor.selection.getContent() + '<br><br>[/' + ctsc_vars.prefix + 'column_fifth][' + ctsc_vars.prefix + 'column_fifth' + element_style + ']<br><br>' + editor.selection.getContent() + '<br><br>[/' + ctsc_vars.prefix + 'column_fifth][' + ctsc_vars.prefix + 'column_fifth' + element_style + ']<br><br>' + editor.selection.getContent() + '<br><br>[/' + ctsc_vars.prefix + 'column_fifth][' + ctsc_vars.prefix + 'column_fifth_last' + element_style + ']<br><br>' + editor.selection.getContent() + '<br><br>[/' + ctsc_vars.prefix + 'column_fifth_last]'); break;
										}
									}
								});
							}
						...
						},
						{
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									body: ctsc_generator_animation,
									onsubmit: function(e){
										editor.selection.setContent('[' + ctsc_vars.prefix + 'animation delay="' + e.data.delay +  '" animation="' + e.data.animation +  '" id="' + e.data.id +  '" class="' + e.data.class +  '"][/' + ctsc_vars.prefix + 'animation]');
									}
								});
							}
						},
						{
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									body: ctsc_generator_spacer,
									onsubmit: function(e){
										editor.selection.setContent('[' + ctsc_vars.prefix + 'spacer height="' + e.data.height +  '"]');
									}
								});
							}
						},
						{ 
							text:'Clearing DIV', 
							onclick: function(){ 
								editor.selection.setContent('[' + ctsc_vars.prefix + 'clear]'); 
							} 
						},
					]
				}
...
//Icons
var ctsc_generator_general_icons = [
	{ text:'(none)', value:'' },
...
//General
var ctsc_generator_general_animation = [
	{ text:'None', value:'' },
...
var ctsc_generator_button = [
	...
	{ type:'listbox', name:'icon', label:'Button Icon', values:ctsc_generator_general_icons },
...
//Testimonials
var ctsc_generator_testimonial = [
	{ type:'textbox', name:'name', label:'Name', value:'John Doe' }, 
...
//Single tab
var ctsc_generator_tab = [
	{ type:'textbox', name:'title', label:'Title', value:'Title' },
];


//Slideshow
var ctsc_generator_slideshow = [
...
var ctsc_generator_section = [
	...
	{ type:'textbox', name:'gradient', label:'Gradient', value:'' },
